...
@objc public enum HCRequestType: Int {
    case hzRequest
//    case jyRequest
//    case wjRequest
//    case zxRequest
...
public extension HCTargetType {
    var hc_headers: [String: String] {
        
        var headers = HCHeaders.httpHeaders()
        ...
        case .hzRequest:
            headers["Host"] = "api.vivaiacollection.com"
...
public protocol HCTargetType: TargetType {
    
    var servicePath: String { get }
    var contentType: String? { get }
    var requestType: HCRequestType { get }
}

@objc public class HCHeaders: NSObject {
