...
@implementation UIView (STLBadge)
...
- (void)showHollowBgStyle
{
    ...
    self.badgeTextColor = [OSSVThemesColors col_FF4E6A];
    self.badge.layer.borderColor = [OSSVThemesColors col_FF4E6A].CGColor;
...
- (void)badgeInit
{
    if (self.badgeBgColor == nil) {
        self.badgeBgColor = [OSSVThemesColors col_FF4E6A];
    }
