...
/** 每张图片对应要显示的Html文字数组 */
@property (nonatomic, strong) NSArray *titlesAttrGroup;
...
@property(nonatomic,assign) NSInteger titleLabelNmberOfLines;
...
/** 分页控件距离轮播图的底部间距（在默认间距基础上）的偏移量 */
@property (nonatomic, assign) CGFloat pageControlBottomNewOffset;

/** 分页控件距离轮播图的右边间距（在默认间距基础上）的偏移量 */
@property (nonatomic, assign) CGFloat pageControlRightOffset;
/** 分页控件距离轮播图的右边间距（在默认间距基础上）的偏移量 */
@property (nonatomic, assign) CGFloat pageControlRightNewOffset;
