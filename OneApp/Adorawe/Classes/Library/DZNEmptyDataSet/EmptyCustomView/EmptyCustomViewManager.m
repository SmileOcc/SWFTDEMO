...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(self.mas_top).offset(52 * DSCREEN_HEIGHT_SCALE);
        ...
        refreshButton.backgroundColor = [OSSVThemesColors col_262626];
        refreshButton.titleLabel.font = [UIFont systemFontOfSize:14];
        [refreshButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [refreshButton setTitle:STLLocalizedString_(@"refresh", nil) forState:UIControlStateNormal];
