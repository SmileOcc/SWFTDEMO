...
- (id)init {
    ...
    if (self) {
        ...
        // fpsLabel
        fpsLabel = [[UILabel alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width-80, 0, 50, 20)];
        BOOL isiPhoneX = ([[UIScreen mainScreen] bounds].size.height >= 812.f);
        if (isiPhoneX) {
            fpsLabel.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-80, 24, 50, 20);
        }
