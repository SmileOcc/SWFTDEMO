...
//        }];
        @weakify(self)
        [self.photoImageView yy_setImageWithURL:[NSURL URLWithString:_photoModel.image_HD_U] placeholder:image options:YYWebImageOptionShowNetworkActivity progress:^(NSInteger receivedSize, NSInteger expectedSize) {
            @strongify(self)
            ...
            if(image!=nil && self.progressView.progress <1.0f) {
