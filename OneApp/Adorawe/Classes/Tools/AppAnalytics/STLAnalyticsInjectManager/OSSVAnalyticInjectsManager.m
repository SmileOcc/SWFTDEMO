...
@implementation OSSVAnalyticInjectsManager

+(instancetype)shareInstance
{
    static dispatch_once_t onceToken;
    static OSSVAnalyticInjectsManager *manager = nil;
...
-(void)analyticsInject:(NSObject *)fromObject injectObject:(id<OSSVAnalyticInjectsProtocol>)injectObject
{
    ...
    if (!injectObject) {
        STLLog(@"injectObject is nil");
        return;
    }
    if (![injectObject conformsToProtocol:@protocol(OSSVAnalyticInjectsProtocol)]) {
        STLLog(@"need AnalyticsInjectManagerProtocol");
        return;
    }
    ...
    if (![methodParams isKindOfClass:[NSDictionary class]]) {
        STLLog(@"injectMenthodParams error");
        return;
    }
    //执行后置方法hook
...
- (void)aspect_injectMethodParams:(NSDictionary *)methodParams
                     ...
                     injectObject:(id<OSSVAnalyticInjectsProtocol>)injectObject
