...
@property (nonatomic, strong) OSSVCategorysVirtualListsViewModel *viewModel;
@property (nonatomic, strong) OSSVCategorysVirtualListsCollectionView *collectionView;
...
- (OSSVCategorysVirtualListsViewModel *)viewModel
{
    if (!_viewModel)
    {
        _viewModel = [OSSVCategorysVirtualListsViewModel new];
...
- (OSSVCategorysVirtualListsCollectionView *)collectionView
{
    if (!_collectionView)
    {
        ...
        _collectionView = [[OSSVCategorysVirtualListsCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:waterFallLayout];
