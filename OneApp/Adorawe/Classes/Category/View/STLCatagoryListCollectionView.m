...
- (instancetype)initWithFrame:(CGRect)frame collectionViewLayout:(UICollectionViewLayout *)layout
{
    if (self = [super initWithFrame:frame collectionViewLayout:layout])
    {
        ...
        self.delegate = self;
        [self registerClass:[STLCategoryListCCell class] forCellWithReuseIdentifier:identifier];
    }
    return self;
}
...
{
    STLCategoryListCCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(STLCategoryListCCell.class) forIndexPath:indexPath];
...
{
//    CGFloat height = [STLCategoryListCCell categoryListCCellRowHeightForListModel:self.dataArray[indexPath.row]];
    ...
    CGFloat height = [STLCategoryListCCell categoryListCCellRowHeightOneModel:oneModel twoModel:twoModel];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [STLAnalytics analyticsGAEventWithName:@"select_item" parameters:itemsDic];
    ...
    if (USERID) {
        ...
        //取消收藏
            [self requestCollectDelNetwork:@[model.goodsId,model.wid] completion:^(id obj) {
                ...
                [STLAnalytics analyticsGAEventWithName:@"wishList_action" parameters:itemsDic];
            ...
            [self requestCollectAddNetwork:@[model.goodsId,model.wid] completion:^(id obj) {
                ...
                // 谷歌统计 收藏
                [STLAnalytics appsFlyeraAddToWishlistWithProduct:model fromProduct:YES];
                ...
                [STLAnalytics analyticsGAEventWithName:@"add_to_wishlist" parameters:itemsDic];
                ...
                [STLAnalytics analyticsSensorsEventWithName:@"GoodsCollect" parameters:sensorsDic];
