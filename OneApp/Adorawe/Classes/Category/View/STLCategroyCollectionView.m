...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (allCategorys.count > indexPath.section) {
        if ([allCategorys[indexPath.section] isKindOfClass:[OSSVCategorysModel class]]) {
            ...
            return CGSizeMake([STLCategoryViewModel secondRangeCollectionWidth],[OSSVCategoyScrollrViewCCell scrollViewContentH:allCategorys[indexPath.section]]);
        }
    }
    CGSize size = [STLCategoryViewModel cellRangeItemSize];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    headerView.backgroundColor = [STLThemeColor stlWhiteColor];
...
- (void)categoriesCell:(OSSVCategoyScrollrViewCCell *)cell advModel:(STLAdvEventModel *)model isBanner:(BOOL)isBanner {
