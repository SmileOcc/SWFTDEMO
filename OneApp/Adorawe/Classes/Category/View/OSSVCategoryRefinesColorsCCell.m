...
- (void)setModel:(STLCategoryFilterValueModel *)model {
    ...
    self.colorView.backgroundColor = [OSSVThemesColors stlWhiteColor];
...
- (STLColorView *)colorView {
    if (!_colorView) {
        ...
        _colorView.layer.borderColor = [OSSVThemesColors col_EEEEEE].CGColor;
    }
    return _colorView;
}
...
- (UILabel *)colorTitleLabel {
    if (!_colorTitleLabel) {
        ...
        _colorTitleLabel.textColor = [OSSVThemesColors col_666666];
