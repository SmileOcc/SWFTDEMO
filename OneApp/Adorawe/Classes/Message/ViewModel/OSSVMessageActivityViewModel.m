//
//  OSSVMessageActivityViewModel.m
// XStarlinkProject
//
...
@interface OSSVMessageActivityViewModel()

@property(nonatomic, assign) NSInteger curPage;

@end

@implementation OSSVMessageActivityViewModel
...
-(void)requestNetwork:(id)parmaters
    ...
    [[STLNetworkStateManager sharedManager] networkState:^{
        ...
        OSSVMessageAip *api = [[OSSVMessageAip alloc] initWithPage:self.curPage type:@"3"];
