...
#import "STLAccountAdvertiseItemView.h"
...
@property (weak,nonatomic) STLAccountAdvertiseItemView *coinEnter;
@property (weak,nonatomic) STLAccountAdvertiseItemView *luckyDrawEnter;
@end
...
-(void)setupItems{
    STLAccountAdvertiseItemView *coinEnter = [[STLAccountAdvertiseItemView alloc] init];
    _coinEnter = coinEnter;
    coinEnter.tag = 1001;
    STLAccountAdvertiseItemView *luckyDrawEnter = [[STLAccountAdvertiseItemView alloc] init];
...
-(void)didtapedButton:(STLAccountAdvertiseItemView *)itemView{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@?is_app=1&token=%@&lang=%@&currency=%@&version=%@&platform=%@&device_id=%@",urlString,STLToString(USER_TOKEN),lang,rate.code,versionStr,platform,device_id];
