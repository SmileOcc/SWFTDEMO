...
- (void)initViewWithFrame:(CGRect)frame {
    ...
    _topBgView.backgroundColor = [OSSVThemesColors col_F5F5F5];
    ...
    _title.textColor = [OSSVThemesColors col_FF6734];
    ...
    _subtitle.textColor = [OSSVThemesColors col_333333];
...
//    [_phoneNum stlPlaceholderColor:[OSSVThemesColors col_808080]];
    _phoneNum.textColor = [OSSVThemesColors col_808080];

    _phoneNum.font = [UIFont systemFontOfSize:12];
    _phoneNum.layer.cornerRadius = 4.0;
    _phoneNum.layer.masksToBounds = YES;
    _phoneNum.backgroundColor = [OSSVThemesColors col_F5F5F5];
    ...
    [_sendSMSBtn setTitleColor:[OSSVThemesColors stlWhiteColor] forState:UIControlStateNormal];
    _sendSMSBtn.backgroundColor = [OSSVThemesColors stlBlackColor];
    ...
    [_verifyCode stlPlaceholderColor:[OSSVThemesColors col_999999]];
    _verifyCode.textColor = [OSSVThemesColors col_262626];
    _verifyCode.font = [UIFont systemFontOfSize:12];
    _verifyCode.layer.borderColor = [[OSSVThemesColors col_E6E6E6] CGColor];
    _verifyCode.layer.cornerRadius = 4.0;
    _verifyCode.layer.masksToBounds = YES;
    _verifyCode.layer.borderWidth = 1.0;
    _verifyCode.backgroundColor = [OSSVThemesColors stlWhiteColor];
    ...
    _errorPrompt.textColor = [OSSVThemesColors col_FF6734];
    ...
    [_verifyBtn setTitleColor:[OSSVThemesColors stlWhiteColor] forState:UIControlStateNormal];
    _verifyBtn.backgroundColor = [OSSVThemesColors col_CCCCCC];
    ...
    _tipBgView.backgroundColor = [OSSVThemesColors col_F5F5F5];
    ...
    _subtitle = [[UILabel alloc] init];
    _subtitle.numberOfLines = 0;
    _subtitle.textColor = [OSSVThemesColors col_999999];
...
- (void)sendSMSSuccess:(NSNotification *)noti {
    ...
    _sendSMSBtn.backgroundColor = [OSSVThemesColors col_262626];
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (code.length > 0) {
        ...
        self.verifyBtn.backgroundColor = [OSSVThemesColors col_262626];
    } else {
        self.verifyBtn.enabled = NO;
        self.verifyBtn.backgroundColor = [OSSVThemesColors col_CCCCCC];
    }
...
- (void)setUserPhoneNum:(NSString *)userPhoneNum paymentAmount:(NSString *)paymentAmount {
    ...
    [[OSSVAnalyticPagesManager sharedManager] pageStartTime:NSStringFromClass(OSSVSMSVerifysView.class)];
}

- (void)coolse {
    
    NSString *startTime = [[OSSVAnalyticPagesManager sharedManager] startPageTime:NSStringFromClass(OSSVSMSVerifysView.class)];
    NSString *endTime = [[OSSVAnalyticPagesManager sharedManager] endPageTime:NSStringFromClass(OSSVSMSVerifysView.class)];

    NSString *timeLeng = [[OSSVAnalyticPagesManager sharedManager] pageEndTimeLength:NSStringFromClass(OSSVSMSVerifysView.class)];
