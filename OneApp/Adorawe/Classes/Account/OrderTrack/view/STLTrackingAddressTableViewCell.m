...
//根据不同物流状态改变文本和图标颜色
    if (model.alreadySign) {
        ...
        self.addressMapBgView.backgroundColor = STLThemeColor.col_0D0D0D;
        self.addressMapBgView.layer.borderColor = STLThemeColor.col_0D0D0D.CGColor;
        self.titleLabel.textColor = STLThemeColor.col_999999;
        self.addressCotentLabel.textColor = STLThemeColor.col_999999;
    } else {
        self.addressImgView.image = [UIImage imageNamed:@"address_gray"];
        self.addressMapBgView.backgroundColor = STLThemeColor.col_F5F5F5;
        self.addressMapBgView.layer.borderColor = STLThemeColor.col_CCCCCC.CGColor;
        self.titleLabel.textColor = STLThemeColor.col_999999;
        self.addressCotentLabel.textColor = STLThemeColor.col_999999;
    }
}
...
- (UIView *)addressMapBgView {
    if (!_addressMapBgView) {
        ...
        _addressMapBgView.backgroundColor = STLThemeColor.col_F5F5F5;
        _addressMapBgView.layer.cornerRadius = 12;
        _addressMapBgView.layer.borderColor = STLThemeColor.col_CCCCCC.CGColor;
...
- (UILabel *)addressCotentLabel {
    if (!_addressCotentLabel) {
        ...
        _addressCotentLabel.textColor = STLThemeColor.col_999999;
