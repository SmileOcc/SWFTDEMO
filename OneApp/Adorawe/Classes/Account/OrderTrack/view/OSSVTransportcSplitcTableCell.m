...
- (UIView *)trackBgView {
    if (!_trackBgView) {
        ...
        _trackBgView.backgroundColor = OSSVThemesColors.col_FFFFFF;
...
- (UILabel *)trackCodeNum {
    if (!_trackCodeNum) {
        ...
        _trackCodeNum.textColor = OSSVThemesColors.col_666666;
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[OSSVTransporSplitCollectionCCell class] forCellWithReuseIdentifier:@"OSSVTransporSplitCollectionCCell"];
        _collectionView.backgroundColor = OSSVThemesColors.col_FFFFFF;
...
- (UILabel *)goodsNumLabel {
    if (!_goodsNumLabel) {
        ...
        _goodsNumLabel.backgroundColor = OSSVThemesColors.col_FFFFFF;
        _goodsNumLabel.textColor = OSSVThemesColors.col_666666;
...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    OSSVTransporSplitCollectionCCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"OSSVTransporSplitCollectionCCell" forIndexPath:indexPath];
