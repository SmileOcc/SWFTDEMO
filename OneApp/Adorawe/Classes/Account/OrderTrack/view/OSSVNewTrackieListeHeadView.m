...
- (UILabel *)trackStatus {
    if (!_trackStatus) {
        ...
        _trackStatus.textColor = OSSVThemesColors.col_0D0D0D;
...
- (UILabel *)timeLabel {
    if (!_timeLabel) {
        ...
        _timeLabel.textColor = OSSVThemesColors.col_666666;
...
//        _trackNumLabel.text = @"No logistics tracking number";
        _trackNumLabel.textColor = OSSVThemesColors.col_666666;
...
- (UIView *)grayLineView {
    if (!_grayLineView) {
        ...
        _grayLineView.backgroundColor = OSSVThemesColors.col_F5F5F5;
    }
