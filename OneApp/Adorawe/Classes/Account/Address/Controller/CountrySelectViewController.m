...
- (void)loadData {
//    if ([AccountManager sharedManager].countryList.count <= 0) {
...
- (void)initView {
    ...
    _tableView.separatorColor = STLThemeColor.col_F1F1F1;
    _tableView.allowsSelection = YES;
    _tableView.sectionIndexColor = [UIColor blackColor];
    [_tableView registerClass:[STLCountryViewCell class] forCellReuseIdentifier:NSStringFromClass(STLCountryViewCell.class)];
...
- (CountryViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[CountryViewModel alloc]init];
