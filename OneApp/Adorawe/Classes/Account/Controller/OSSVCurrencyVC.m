...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    OSSVMyCurrencysCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(OSSVMyCurrencysCell.class) forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    [tableView roundedGroupWithWillDisplay:cell forRowAt:indexPath radius:6 backgroundColor:OSSVThemesColors.stlWhiteColor horizontolPadding:0];
}
...
- (UITableView *)currencyTable {
    if (!_currencyTable) {
        ...
        _currencyTable.backgroundColor = OSSVThemesColors.stlClearColor;
        ...
        [_currencyTable registerClass:[OSSVMyCurrencysCell class] forCellReuseIdentifier:NSStringFromClass(OSSVMyCurrencysCell.class)];
...
- (UIButton *)saveButton {
    if (!_saveButton) {
        ...
        [_saveButton setTitleColor:OSSVThemesColors.col_333333 forState:UIControlStateNormal];
        [_saveButton setTitleColor:OSSVThemesColors.col_DDDDDD forState:UIControlStateDisabled];
