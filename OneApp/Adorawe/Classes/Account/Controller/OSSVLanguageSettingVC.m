...
- (void)initData {
    ...
    // 从我的模块进来
    NSArray <OSSVSupporteLangeModel *>*countrySupportLang = [STLLocalizationString shareLocalizable].languageArray;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    OSSVLanguaSettingsCell *cell = [tableView dequeueReusableCellWithIdentifier:kLangugeIdentifier];
...
- (void)saveButtonAction {
    ...
    //只有用户手动选择了语言，才保存
    OSSVSupporteLangeModel *supportModel = self.languageArray[_selectedIndex];
...
- (UITableView *)langugeTableView {
    if (!_langugeTableView) {
        ...
        [_langugeTableView registerClass:[OSSVLanguaSettingsCell class] forCellReuseIdentifier:kLangugeIdentifier];
    }
