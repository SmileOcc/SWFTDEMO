...
//    model.unAvailabel = NO;
    ...
    if (APP_TYPE == 3) {
        ...
        [self addlayerWithView:self.bottomView withStokeColor:OSSVThemesColors.col_F5EEE9  lineColor:@"#FFFFFF"];
    } else {
        [self addlayerWithView:self.bottomView withStokeColor:OSSVThemesColors.col_0D0D0D  lineColor:@"#FFFFFF"];

    }
    
    self.leftColorView.backgroundColor = [OSSVThemesColors col_F5EEE9];
    if ([model.flag isEqualToString:@"expired"] || [model.flag isEqualToString:@"used"] || model.unAvailabel) {
            
        if (APP_TYPE == 3) {
            self.leftColorView.backgroundColor = [OSSVThemesColors col_C4C4C4];
            self.gradientLayer.backgroundColor = [OSSVThemesColors stlWhiteColor].CGColor;
            self.borderlayer.strokeColor = [OSSVThemesColors col_E1E1E1].CGColor;
            self.borderlayer.lineWidth = 1;

            self.couponSave.textColor = [OSSVThemesColors col_000000:0.5];
            self.couponPrice.textColor = [OSSVThemesColors col_000000:0.5];
            self.couponEx.textColor = [OSSVThemesColors col_000000:0.5];
            self.couponState.textColor = [OSSVThemesColors col_000000:0.5];
            self.couponCode.textColor = [OSSVThemesColors col_000000:0.5];
            self.couponCalidity.textColor = [OSSVThemesColors col_000000:0.5];
            self.otherConditionAllow.textColor = [OSSVThemesColors col_000000:0.5];
            self.couponAllow.textColor = [OSSVThemesColors col_000000:0.5];
            
            self.couponEx.backgroundColor = [OSSVThemesColors col_F8F8F8];
            self.couponState.backgroundColor = [OSSVThemesColors col_F8F8F8];
            ...
            if (!STLIsEmptyString(model.type_notes)) {
                ...
                iconImage = [iconImage imageWithColor:[OSSVThemesColors col_000000:0.5]];
                ...
                _couponTipLabel.textColor = [OSSVThemesColors col_000000:0.5];
            }
            
        } else {
            self.borderlayer.strokeColor = [OSSVThemesColors col_EEEEEE].CGColor;
            self.borderlayer.lineWidth = 1;
            self.gradientLayer.colors =@[(__bridge id)OSSVThemesColors.col_FFFFFF.CGColor,(__bridge id)OSSVThemesColors.col_FFFFFF.CGColor];
            
            self.couponSave.textColor = [OSSVThemesColors col_B2B2B2];
            self.couponPrice.textColor = [OSSVThemesColors col_B2B2B2];
            self.couponEx.textColor = [OSSVThemesColors col_B2B2B2];
            self.couponState.textColor = [OSSVThemesColors col_B2B2B2];
            self.couponCode.textColor = [OSSVThemesColors col_B2B2B2];
            self.couponCalidity.textColor = [OSSVThemesColors col_B2B2B2];
            self.otherConditionAllow.textColor = [OSSVThemesColors col_B2B2B2];
            self.couponAllow.textColor = [OSSVThemesColors col_B2B2B2];
            
            self.couponEx.backgroundColor = [OSSVThemesColors col_F5F5F5];
            self.couponState.backgroundColor = [OSSVThemesColors col_F5F5F5];
        }
        ...
        if (APP_TYPE == 3) {
            self.gradientLayer.backgroundColor = [OSSVThemesColors stlWhiteColor].CGColor;
            self.borderlayer.strokeColor = [OSSVThemesColors col_F5EEE9].CGColor;
            self.borderlayer.lineWidth = 1;

            self.couponPrice.textColor = [OSSVThemesColors col_9F5123];
            self.couponEx.textColor = [OSSVThemesColors col_9F5123];
            self.couponState.textColor = [OSSVThemesColors col_9F5123];
            
            self.couponSave.textColor = [OSSVThemesColors col_000000:0.7];
            self.couponCode.textColor = [OSSVThemesColors col_000000:0.7];
            self.couponCalidity.textColor = [OSSVThemesColors col_000000:0.7];
            self.otherConditionAllow.textColor = [OSSVThemesColors col_000000:0.7];
            self.couponAllow.textColor = [OSSVThemesColors col_000000:0.7];
            
            self.couponEx.backgroundColor = [OSSVThemesColors stlWhiteColor];
            self.couponState.backgroundColor = [OSSVThemesColors stlWhiteColor];
            ...
            if (!STLIsEmptyString(model.type_notes)) {
                ...
                _couponTipLabel.adjustsFontSizeToFitWidth = YES;
                _couponTipLabel.minimumScaleFactor = 0.9;
                _couponTipLabel.textColor = [OSSVThemesColors col_E34E4E];
            }
            ...
            self.couponSave.textColor = [OSSVThemesColors col_B62B21];
            self.couponPrice.textColor = [OSSVThemesColors col_B62B21];
            self.couponEx.textColor = [OSSVThemesColors col_B62B21];
            self.couponState.textColor = [OSSVThemesColors col_B62B21];
            self.couponCode.textColor = [OSSVThemesColors col_6C6C6C];
            self.couponCalidity.textColor = [OSSVThemesColors col_6C6C6C];
            self.otherConditionAllow.textColor = [OSSVThemesColors col_6C6C6C];
            self.couponAllow.textColor = [OSSVThemesColors col_6C6C6C];
            
            self.couponEx.backgroundColor = [OSSVThemesColors col_FBE9E9];
            self.couponState.backgroundColor = [OSSVThemesColors col_FBE9E9];
        }
    ...
    if (model.isSelected) {
        if (APP_TYPE == 3) {
            self.borderlayer.strokeColor = [OSSVThemesColors col_9F5123].CGColor;
        } else {
...
- (UILabel *)couponState {
    if (!_couponState) {
        ...
        if (APP_TYPE == 3) {
            ...
            _couponState.layer.borderColor = [OSSVThemesColors col_F5EEE9].CGColor;
        }
    }
    return _couponState;
}
...
- (UILabel *)couponEx {
    if (!_couponEx) {
        ...
        if (APP_TYPE == 3) {
            ...
            _couponEx.layer.borderColor = [OSSVThemesColors col_F5EEE9].CGColor;
        }
...
- (UIView *)leftColorView {
    if (!_leftColorView) {
        ...
        _leftColorView.backgroundColor = OSSVThemesColors.col_F5EEE9;
...
- (UIView *)leftCircleView {
    if (!_leftCircleView) {
        ...
        _leftCircleView.backgroundColor = [OSSVThemesColors col_F5F5F5];
...
- (UIView *)vSelectlayerView {
    if (!_vSelectlayerView) {
        ...
        _vSelectlayerView.backgroundColor = [OSSVThemesColors stlClearColor];
...
//    gradientLayer.colors = @[(__bridge id)[UIColor colorWithHexString:@"#FFF1F1"].CGColor,(__bridge id)[UIColor colorWithHexString:@"#FFF5F5"].CGColor,(__bridge id)[UIColor colorWithHexString:@"#FBE9E9"].CGColor];
    ...
    if (APP_TYPE == 3) {
        gradientLayer.backgroundColor = (__bridge CGColorRef _Nullable)([OSSVThemesColors stlWhiteColor]);
    } else {
