...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.bgView.backgroundColor = [OSSVThemesColors stlWhiteColor];
...
- (UIView *)bgColorView {
    if (!_bgColorView) {
        ...
        _bgColorView.backgroundColor = [OSSVThemesColors col_EEEEEE];
    }
    return _bgColorView;
}
...
- (UILabel *)questionTypeDesc {
    if (!_questionTypeDesc) {
        ...
        _questionTypeDesc.textColor = [OSSVThemesColors col_0D0D0D];
