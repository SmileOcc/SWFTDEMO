...
- (void)setModel:(AccountOrdersDetailGoodsModel *)model {
    _model = model;
    ...
    if (_model.isReview == 1) {
        [_reviewButton setTitleColor:[STLThemeColor col_333333] forState:UIControlStateNormal];
        _reviewButton.layer.borderColor = [STLThemeColor col_EEEEEE].CGColor;
        ...
        _reviewButton.backgroundColor = [STLThemeColor col_262626];
        _reviewButton.layer.borderColor = [STLThemeColor col_262626].CGColor;
        [_reviewButton setTitleColor:[STLThemeColor stlWhiteColor] forState:UIControlStateNormal];
...
- (void)testModel {
    ...
    if (self.model.isReview) {
        _reviewButton.layer.borderColor = [STLThemeColor col_CCCCCC].CGColor;
        _reviewButton.backgroundColor = [UIColor clearColor];
        [_reviewButton setTitleColor:[STLThemeColor col_333333] forState:UIControlStateNormal];
    } else {
        [_reviewButton setTitleColor:[STLThemeColor stlWhiteColor] forState:UIControlStateNormal];
...
- (UIImageView *)goodsImgView {
    if (!_goodsImgView) {
        ...
        _goodsImgView.layer.borderColor = [STLThemeColor col_EEEEEE].CGColor;
...
- (UILabel *)titleLab {
    if (!_titleLab) {
        ...
        _titleLab.textColor = [STLThemeColor col_6C6C6C];
...
- (UILabel *)skuLab {
    if (!_skuLab) {
        ...
        _skuLab.textColor = [STLThemeColor col_6C6C6C];
...
- (UIButton *)reviewButton {
    if (!_reviewButton) {
        ...
        [_reviewButton setTitleColor:[STLThemeColor stlWhiteColor] forState:UIControlStateNormal];
        _reviewButton.backgroundColor = [STLThemeColor col_0D0D0D];
        _reviewButton.layer.borderColor = [STLThemeColor col_0D0D0D].CGColor;
...
//        _lineView.backgroundColor = STLThemeColor.col_F1F1F1;
//    }
//    return _lineView;
//}
