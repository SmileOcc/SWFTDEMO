...
#import "OSSVOrdereMenuItemeModel.h"
...
- (NSArray *)menuTitlesArray {
    if (!_menuTitlesArray) {
        ...
        for (int i=0; i<tempArray.count; i++) {
            OSSVOrdereMenuItemeModel *itemModel = [[OSSVOrdereMenuItemeModel alloc] init];
...
- (NSString *)pageController:(WMPageController *)pageController titleAtIndex:(NSInteger)index {
    ...
    if (self.menuTitlesArray.count > index) {
        OSSVOrdereMenuItemeModel *item = self.menuTitlesArray[index];
