...
- (UIView *)topLineView {
    if (!_topLineView) {
        ...
        _topLineView.backgroundColor = [OSSVThemesColors col_EEEEEE];
    }
    return _topLineView;
}
...
- (UIButton *)payNowBtn {
    if (!_payNowBtn) {
        ...
        _payNowBtn.backgroundColor = [OSSVThemesColors col_0D0D0D];
        ...
        _payNowBtn.layer.borderColor = [OSSVThemesColors col_0D0D0D].CGColor;
...
- (UIButton *)buyAgainBtn {
    if (!_buyAgainBtn) {
        ...
        _buyAgainBtn.layer.borderColor = [OSSVThemesColors col_EEEEEE].CGColor;
        [_buyAgainBtn setTitleColor:[OSSVThemesColors col_0D0D0D] forState:UIControlStateNormal];
...
- (UIButton *)reviewBtn {
    if (!_reviewBtn) {
        ...
        _reviewBtn.layer.borderColor = [OSSVThemesColors col_EEEEEE].CGColor;
        [_reviewBtn setTitleColor:[OSSVThemesColors col_0D0D0D] forState:UIControlStateNormal];
