...
-(UILabel *)topsLabel
{
    if (!_topsLabel) {
        _topsLabel = ({
            ...
            label.textColor = STLThemeColor.col_333333;
...
-(UILabel *)phoneNum
{
    if (!_phoneNum) {
        _phoneNum = ({
            ...
            label.textColor = STLThemeColor.col_FF6F00;
...
-(UILabel *)tipslLabel
{
    if (!_tipslLabel) {
        _tipslLabel = ({
            ...
            [attrString addAttributes:@{NSForegroundColorAttributeName : STLThemeColor.col_FF6F00} range:hoursRange];
