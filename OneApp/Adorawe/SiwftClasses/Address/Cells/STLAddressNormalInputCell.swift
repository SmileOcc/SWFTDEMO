//
//  STLAddressNormalInputCell.swift
// XStarlinkProject
//
...
class STLAddressNormalInputCell: UITableViewCell {
    ...
    weak var detailTextfield:NormalInputFiled?
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let detailTextfield = NormalInputFiled(frame: .zero)
