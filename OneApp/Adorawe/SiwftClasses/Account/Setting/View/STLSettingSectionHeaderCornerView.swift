//
//  STLSettingSectionHeaderCornerView.swift
// XStarlinkProject
//
...
class STLSettingSectionHeaderCornerView: UIView {
    ...
    @objc init(rect:CGRect, size: CGSize) {
        ...
        view.stlAddCorners(UIRectCorner(rawValue: UIRectCorner.topLeft.rawValue | UIRectCorner.topRight.rawValue), cornerRadii: size)
