...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (self.isFirstAppear && !imagePickerVc.navLeftBarButtonSettingBlock) {
        self.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:[NSBundle tz_localizedStringForKey:@" "] style:UIBarButtonItemStylePlain target:nil action:nil];
    }
