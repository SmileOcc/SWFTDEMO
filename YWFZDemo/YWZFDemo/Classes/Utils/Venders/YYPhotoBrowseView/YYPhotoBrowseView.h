...
@property (nonatomic, copy) void(^dismissCompletion)(NSInteger currentPage);// add by V4.6.0在商详使用时用到
@property (nonatomic, copy) void(^startDismissCompletion)(NSInteger currentPage);// add by V4.6.0帖子详情使用时用到
