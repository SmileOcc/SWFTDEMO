    ...
    if(_isCustomToastView == NO){
        ...
        switch (self.toastType) {
            ...
            case FFToastTypeSuccess: {
                if (!_iconImage) {
                    self.iconImage = [FFBaseToastView getToastImageWithName:@"fftoast_success_highlight"];
                }
                break;
            }
            case FFToastTypeError: {
                if (!_iconImage) {
                    self.iconImage = [FFBaseToastView getToastImageWithName:@"fftoast_error_highlight"];
                }
                break;
            }
            case FFToastTypeWarning: {
                if (!_iconImage) {
                    self.iconImage = [FFBaseToastView getToastImageWithName:@"fftoast_warning_highlight"];
                }
                break;
            }
            case FFToastTypeInfo: {
                ...
                if (!_iconImage) {
                    self.iconImage = [FFBaseToastView getToastImageWithName:@"fftoast_info_highlight"];
                }
                break;
            }
...
-(void)layoutSubviews{
    ...
    if(_enableDismissBtn == YES){
        if (_dismissBtnImage != nil) {
            ...
            [self.dismissBtn setImage:[FFBaseToastView getToastImageWithName:@"fftoast_dismiss"] forState:UIControlStateNormal];
        }
