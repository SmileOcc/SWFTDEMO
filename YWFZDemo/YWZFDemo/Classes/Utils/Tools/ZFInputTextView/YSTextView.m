...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([SystemConfigUtils isRightToLeftShow]) {
        CGSize size = [ZFToString(self.placeholder)  sizeWithAttributes:@{NSFontAttributeName: self.placeholderFont ? self.placeholderFont :  ZFFontSystemSize(14)}];

        rect.origin.x =  KScreenWidth - self.placeholderPoint.x - size.width;
