//
//  UIButton+ZFButtonCategorySet.h
//  ZZZZZ
//
...
typedef NS_ENUM(NSUInteger, ZFButtonEdgeInsetsStyle) {
    ZFButtonEdgeInsetsStyleTop, // image在上，label在下
    ZFButtonEdgeInsetsStyleLeft, // image在左，label在右
    ZFButtonEdgeInsetsStyleBottom, // image在下，label在上
    ZFButtonEdgeInsetsStyleRight // image在右，label在左
};

typedef void (^ZFTouchedBlock)(UIButton *btn);

@interface UIButton (ZFButtonCategorySet)
 ...
 */
- (void)zfLayoutStyle:(ZFButtonEdgeInsetsStyle)style
