...
/// 获取原图
- (PHImageRequestID) getOriginPoto:(PHAsset *)asset andCompletion: (void (^)(UIImage *))completion andProgress:(void (^)(double progress, NSError *error, BOOL *stop, NSDictionary *info))progressBlock;
