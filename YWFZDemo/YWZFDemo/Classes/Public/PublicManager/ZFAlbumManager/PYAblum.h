...
///当前那个相册资源
@property (nonatomic, strong) PYAblumModel                   *currentAblumModel;
...
///所有相片相册中 资源组
@property (nonatomic,strong) NSArray <PYAblumModel *> *fetchResultsArray;
...
/// 外部导入的临时assetModel
@property (nonatomic,strong) NSMutableArray <PYAssetModel*>*externalImportAssetModelArray;
