...
#import "ZFOrderRewardPointsCell.h"
...
@interface ZFOrderRewardPointsCell ()
...
@implementation ZFOrderRewardPointsCell
...
- (void)setPointsTip:(NSString *)pointsTip {
    _pointsTip = pointsTip;
    [self.rewardTipLabel zf_setHTMLFromString:pointsTip];
}

#pragma mark - Action
- (void)showInfo {
    NSString *help = ZFLocalizedString(@"rewardPointsTip", nil);
