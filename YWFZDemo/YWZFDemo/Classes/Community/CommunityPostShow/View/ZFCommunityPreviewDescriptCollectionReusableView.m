//
//  ZFCommunityPreviewDescriptCollectionReusableView.m
//  ZZZZZ
//
...
#define kTagBeginTag1   9999

@interface ZFCommunityPreviewDescriptCollectionReusableView ()
...
@implementation ZFCommunityPreviewDescriptCollectionReusableView
...
+ (ZFCommunityPreviewDescriptCollectionReusableView *)descriptWithCollectionView:(UICollectionView *)collectionView indexPath:(NSIndexPath *)indexPath {
    ...
    ZFCommunityPreviewDescriptCollectionReusableView *descriptHeaderView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:Identify forIndexPath:indexPath];
