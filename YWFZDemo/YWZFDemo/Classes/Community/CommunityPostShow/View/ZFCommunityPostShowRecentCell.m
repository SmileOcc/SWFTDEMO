//
//  ZFCommunityPostShowRecentCell.m
//  ZZZZZ
//
...
@interface ZFCommunityPostShowRecentCell()
...
@implementation ZFCommunityPostShowRecentCell

+ (ZFCommunityPostShowRecentCell *)postRecentCellWithTableView:(UITableView *)tableView andIndexPath:(NSIndexPath *)indexPath {
    [tableView registerClass:[ZFCommunityPostShowRecentCell class] forCellReuseIdentifier:NSStringFromClass([ZFCommunityPostShowRecentCell class])];
    return [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([ZFCommunityPostShowRecentCell class]) forIndexPath:indexPath];
}
