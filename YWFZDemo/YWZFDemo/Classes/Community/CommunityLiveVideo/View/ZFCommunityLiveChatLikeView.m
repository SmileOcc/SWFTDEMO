...
@interface ZFCommunityLiveChatLikeView () <CAAnimationDelegate>
...
@implementation ZFCommunityLiveChatLikeView
...
- (void)doLikeAnimation {
    ...
    if (self.deleteArray.count > 0) {
        ...
        NSArray *imageList = @[@"live_like_slices",@"live_love_slices",@"live_mail_slices",@"live_photo_slices",@"live_skirt_slices",@"live_tv_slices"];
