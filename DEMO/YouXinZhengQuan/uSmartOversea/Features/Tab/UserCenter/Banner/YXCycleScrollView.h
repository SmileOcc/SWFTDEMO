...
typedef enum {
    ...
    YXCycleScrollViewPageContolAlimentCenter
} YXCycleScrollViewPageContolAliment;

typedef enum {
    YXCycleScrollViewPageContolStyleClassic,        // 系统自带经典样式
    YXCycleScrollViewPageContolStyleAnimated,       // 动画效果pagecontrol
    YXCycleScrollViewPageContolStyleNone            // 不显示pagecontrol
} YXCycleScrollViewPageContolStyle;
...
- (void)cycleScrollView:(YXCycleScrollView *)cycleScrollView willDisplayCell:(UICollectionViewCell *)cell;

- (void)cycleScrollView:(YXCycleScrollView *)cycleScrollView didEndDisplayingCell:(UICollectionViewCell *)cell;
...
- (UINib *)customCollectionViewCellNibForCycleScrollView:(YXCycleScrollView *)view;

/** 如果你自定义了cell样式，请在实现此代理方法为你的cell填充数据以及其它一系列设置 */
- (void)setupCustomCell:(UICollectionViewCell *)cell forIndex:(NSInteger)index cycleScrollView:(YXCycleScrollView *)view;
...
/** 每张图片对应标签数组 */
@property (nonatomic, strong) NSArray *labelsGroup;

/** 本地图片数组 */
@property (nonatomic, strong) NSArray *localizationImageNamesGroup;


/** 每张图片对应要显示的富文本数组， 配合titlesGroup 及  onlyDisplayText使用 */
@property (nonatomic, strong) NSArray *attributeTitlesGroup;
...
@property (nonatomic, weak) id<YXCycleScrollViewDelegate> delegate;
