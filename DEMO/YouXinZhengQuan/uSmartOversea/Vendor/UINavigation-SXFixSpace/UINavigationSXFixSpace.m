...
-(instancetype)init {
    if (self = [super init]) {
        //self.sx_defaultFixSpace = 18;
        self.sx_defaultLeftFixSpace = 16;
        self.sx_defaultRightFixSpace = 16;
...
-(void)sx_setLeftBarButtonItems:(NSArray<UIBarButtonItem *> *)leftBarButtonItems animated:(BOOL)animated {
    if (!UINavigationConfig.shared.sx_disableFixSpace && leftBarButtonItems.count) {//存在按钮且需要调节
        ...
        CGFloat width = UINavigationConfig.shared.sx_defaultLeftFixSpace - UINavigationConfig.shared.sx_systemSpace;
...
- (void)sx_setRightBarButtonItems:(NSArray<UIBarButtonItem *> *)rightBarButtonItems animated:(BOOL)animated {
    if (!UINavigationConfig.shared.sx_disableFixSpace && rightBarButtonItems.count) {//存在按钮且需要调节
        ...
        CGFloat width = UINavigationConfig.shared.sx_defaultRightFixSpace - UINavigationConfig.shared.sx_systemSpace;
        if (firstItem.width == width) {//已经存在space
...
- (void)sx_adjustLeadingBarConstraints {
    ...
    CGFloat constant = UINavigationConfig.shared.sx_defaultLeftFixSpace - UINavigationConfig.shared.sx_systemSpace;
...
- (void)sx_adjustTrailingBarConstraints {
    ...
    CGFloat constant = UINavigationConfig.shared.sx_systemSpace - UINavigationConfig.shared.sx_defaultRightFixSpace;
