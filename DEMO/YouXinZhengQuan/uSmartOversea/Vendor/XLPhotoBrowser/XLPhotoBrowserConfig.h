...
// 图片保存成功提示文字
#define XLPhotoBrowserSaveImageSuccessText [YXLanguageUtility kLangWithKey:@"user_saveSucceed"]//@"保存成功 ";
// 图片保存失败提示文字
#define XLPhotoBrowserSaveImageFailText [YXLanguageUtility kLangWithKey:@"user_saveFailed"]//@"保存失败 ";
// 网络图片加载失败的提示文字
#define XLPhotoBrowserLoadNetworkImageFail [YXLanguageUtility kLangWithKey:@"user_picLoadFailed"]//@"图片加载失败"
#define XLPhotoBrowserLoadingImageText [YXLanguageUtility kLangWithKey:@"user_picIsLoading"]//@"图片加载中,请稍后 ";
