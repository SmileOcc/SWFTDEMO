...
+ (NSString *)safeEncryptString:(NSString *)str publicKey:(NSString *)pubKey{
    NSData *data = [RSA encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] publicKey:pubKey];
    NSString *ret = [RSA safeUrlBase64Encode:data];
    return ret;
}
...
+ (NSString*)safeUrlBase64Encode:(NSData*)data{
    ...
    NSString * base64Str = base64_encode_data(data);
