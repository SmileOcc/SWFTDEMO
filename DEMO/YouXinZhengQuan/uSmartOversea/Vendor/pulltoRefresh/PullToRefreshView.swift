...
class PullToRefreshView: UIView, UIScrollViewDelegate {
    ...
    var titles: [PullToRefreshState:String] = [.pulling:"", .pullingComplate:"", .refreshing:YXLanguageUtility.kLang(key: "common_loading_with_dot"), .end:"", .noMoreData:YXLanguageUtility.kLang(key: "common_no_more_data")]
    ...
    var type = PullToRefreshType.header {
        didSet {
            if type == .footer {
                ...
                titles = [.pulling:"", .pullingComplate:"", .refreshing:YXLanguageUtility.kLang(key: "common_loading_with_dot"), .end:"", .noMoreData:YXLanguageUtility.kLang(key: "common_no_more_data")]
            }
        }
    }
