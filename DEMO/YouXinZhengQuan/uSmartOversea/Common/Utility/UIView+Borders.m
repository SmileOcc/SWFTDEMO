...
-(void)makeCorners:(CGFloat)corners
{
...
- (void)addBorderDashLineWithLineWidth:(CGFloat)lineWidth dashWidth:(CGFloat)dashWidth patterWidth:(CGFloat)patterWidth lineColor:(UIColor *)lineColor cornerRadius:(CGFloat)cornerRadius;
{
    ...
    UIBezierPath *path    = [UIBezierPath bezierPathWithRoundedRect:layer.frame cornerRadius:cornerRadius];
    layer.path             = path.CGPath;
    layer.lineWidth         = lineWidth;
    layer.lineDashPattern    = @[@(dashWidth), @(patterWidth)];
...
- (void)addBorderWithLineWidth:(CGFloat)lineWidth lineColor:(UIColor *)lineColor cornerRadius:(CGFloat)cornerRadius {
    self.layer.borderWidth = lineWidth;
    self.layer.borderColor = lineColor.CGColor;
    [self makeCorners:cornerRadius];
}
