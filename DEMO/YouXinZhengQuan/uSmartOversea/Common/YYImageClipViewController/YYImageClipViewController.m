...
@interface YYImageClipViewController ()
...
@implementation YYImageClipViewController
...
- (void)initControlBtn {
    CGFloat tabbarPadding = YXConstant.tabBarPadding;
    CGFloat btnHeight = 50.0f;
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - btnHeight - tabbarPadding, 100, btnHeight)];
    cancelBtn.backgroundColor = [UIColor clearColor];
    
    cancelBtn.titleLabel.textColor = [UIColor whiteColor];
    [cancelBtn setTitle:[YXLanguageUtility kLangWithKey:@"common_cancel"] forState:UIControlStateNormal];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - btnHeight - tabbarPadding, 100, btnHeight)];
    confirmBtn.backgroundColor = [UIColor clearColor];
    confirmBtn.titleLabel.textColor = [UIColor whiteColor];
    [confirmBtn setTitle:[YXLanguageUtility kLangWithKey:@"common_confirm"] forState:UIControlStateNormal];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(YYImageClipDelegate)]) {
