//
//  YXShareImageContentView  .swift
//  uSmartOversea
//
//  Created by occ on 3/23/22.
...
@objc class YXShareImageContentView  : UIView {
    
    var shareBlock: ((YXShareItemModel) -> Void)?
...
//        self.bgView.isHidden = true
    ...
    convenience init(frame: CGRect,shareType: YXShareType, toolTypes:[YXSharePlatform],thirdTypes:[YXSharePlatform], clickCallBlock:((YXShareItemModel) -> Void)?, cancelCallBlock:(() -> Void)?) {
    ...
    @objc convenience init(frame: CGRect,shareType: YXShareType, items:[YXShareItemModel],thirdItems:[YXShareItemModel], clickCallBlock:((YXShareItemModel) -> Void)?, cancelCallBlock:(() -> Void)?) {
